...
import ve.com.mariomendoza.codegram.BuildConfig;
            ...
            public void onClick(View view) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP){
                    ...
                    activity.startActivity(intent, ActivityOptionsCompat.
                            makeSceneTransitionAnimation(activity,view,activity.getString(R.string.transition_name_picture)).toBundle());
